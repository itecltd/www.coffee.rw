...
<div class = 'hd-mg-ctn'>
<button id = 'logoutBtn'  class = 'btn btn-default btn-icon-notika'><i class = 'notika-icon notika-left-arrow'></i> Sign-Out</button>
</div>
</div>
</div>
</div>
...
document.getElementById('logoutBtn').addEventListener('click', function () {
    fetch(`${BASE_URL}/_ikawa/users/logout`, {
        method: 'POST',
